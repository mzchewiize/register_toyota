...
<meta charset="utf-8">
<meta http-equiv="refresh" content="10; URL=http://api.mzchewiize.com/register/landing-3.php">
...
global $vars;
$sql = "SELECT * FROM  `member` WHERE `created` !='' and device='3' ORDER BY  `created` DESC  LIMIT 1";
